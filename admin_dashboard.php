                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editHotelModal" onclick="editHotel(<?php echo $hotel['id']; ?>)">
                                    ...
                                    <div class="modal fade" id="editHotelModal" tabindex="-1" aria-labelledby="editHotelLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="edit_hotel.php?hotel_id=<?= $hotel['id'] ?>" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="time" class="form-control" id="check_in_edit" name="check_in" value="<?= $hotel['check_in'] ?>">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="check_out_edit" class="form-label">Check-out Time</label>
                                                            <input type="time" class="form-control" id="check_out_edit" name="check_out" value="<?= $hotel['check_out'] ?>">
                                                        </div>
            ...
            function editHotel(id) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#hotel_id').val(response[0].id);
                        $('#price_2d1n_adult_edit').val(response[0].price_2d1n_adult)
                        $('#price_2d1n_kid_edit').val(response[0].price_2d1n_kid)
                        $('#price_3d2n_adult_edit').val(response[0].price_3d2n_adult)
                        $('#price_3d2n_kid_edit').val(response[0].price_3d2n_kid)
                        $('#price_4d3n_adult_edit').val(response[0].price_4d3n_adult)
                        $('#price_4d3n_kid_edit').val(response[0].price_4d3n_kid)
                        $('#hotel_thumbnail_edit').te(response[0].thumbnail_image)
                        $('#hotel_images_edit').val(response[0].gallery_images)
                        $('#check_in_edit').val(response[0].check_in)
                        $('#check_out_edit').val(response[0].check_out)
                        $('#hotel_select_edit option[value="' + response[0].name + '"]').prop('selected', true);
                        $('#capacity_edit option[value="' + response[0].capacity + '"]').prop('selected', true);

                        $('#description_edit').html(response[0].description)
                        $('#inclusions_edit').html(response[0].inclusions)
                        $('#exclusions_edit').html(response[0].exclusions)
                        $('#policy_edit').html(response[0].policy)
                    }
